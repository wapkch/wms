        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <s:select list="#depts" listKey="id" listValue="name" cssClass="ui_select01"
                                  name="employee.dept.id"
                        ></s:select>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <table>
                            <tr>
                                <td>
                                    <s:select list="#roles" multiple="true" cssClass="ui_multiselect01 roleAll"
                                ...
                                <td>
                                    <s:select list="employee.roles" multiple="true" cssClass="ui_multiselect01 roleSelected"
                                              listKey="id" listValue="name" name="employee.roles.id"/>
                                </td>
                            </tr>
                        </table>
                    </td>
