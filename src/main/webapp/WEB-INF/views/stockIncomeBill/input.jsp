            ...
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        ...
                        name="stockIncomeBill.depot.id" cssClass="ui_select03"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="ui_text_lt">
                        ...
                        <s:textfield name="stockIncomeBill.vdate" cssClass="ui_input_txt02 Wdate" onclick="WdatePicker();" value="%{vdate}"/>
                    </td>
                </tr>
                <tr>
