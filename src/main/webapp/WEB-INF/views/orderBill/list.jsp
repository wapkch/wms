                ...
                <div id="box_border">
                    ...
                    <div id="box_center">
                        ...
                        <s:select list="#suppliers" listKey="id" listValue="name" headerKey="-1" headerValue="全部"
                                  cssClass="ui_select01" name="qo.supplierId">
                        </s:select>
                        状态
                        ...
                        <tr>
                            ...
                            <s:if test="status==0">
                                ...
                                <td>
                                    ...
                                    <s:url namespace="/" action="orderBill_delete" var="deleteUrl" escapeAmp="false">
                                        <s:param name="orderBill.id" value="id"/>
                                        <s:param name="orderBill.imagePath" value="imagePath"/>
                                    </s:url>
